...
export const Register = () => {
  const { isLoading, signUpCall, authenticateWithGoogleCall, readGoogleToken } = useAuthentication()
    ...
    {!isLoading && <>
      <div className="w-[50vw]">
        ...
        <div className='flex flex-col gap-8 pl-[21%] pr-[21%] mt-[8%]'>
          ...
          <ButtonGhost className='font-normal' onClick={() => handleSignUpWithGoogle()}>
